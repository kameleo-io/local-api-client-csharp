...
namespace Kameleo.LocalApiClient.Api
{
    ...
    public interface IProfileApiSync : IApiAccessor
    {
        ...
        /// </summary>
        /// <exception cref="Kameleo.LocalApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="lifetimeState">The lifetime state of the profiles to return (optional) (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;ProfilePreview&gt;</returns>
        List<ProfilePreview> ListProfiles(ProfileLifetimeState? lifetimeState = default, int operationIndex = 0);
        ...
        ApiResponse<List<ProfilePreview>> ListProfilesWithHttpInfo(ProfileLifetimeState? lifetimeState = default, int operationIndex = 0);
        /// <summary>
    ...
    public interface IProfileApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<ProfilePreview>> ListProfilesAsync(ProfileLifetimeState? lifetimeState = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<ProfilePreview>>> ListProfilesWithHttpInfoAsync(ProfileLifetimeState? lifetimeState = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Gets the profile with the specified GUID from the current workspace. On startup, Kameleo will automatically scan and load profiles stored  in your workspace folder on startup.
        /// </summary>
        /// <remarks>
    ...
    public partial class ProfileApi : IProfileApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;ProfilePreview&gt;</returns>
        public List<ProfilePreview> ListProfiles(ProfileLifetimeState? lifetimeState = default, int operationIndex = 0)
        {
            Kameleo.LocalApiClient.Client.ApiResponse<List<ProfilePreview>> localVarResponse = ListProfilesWithHttpInfo(lifetimeState);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;ProfilePreview&gt;</returns>
        public Kameleo.LocalApiClient.Client.ApiResponse<List<ProfilePreview>> ListProfilesWithHttpInfo(ProfileLifetimeState? lifetimeState = default, int operationIndex = 0)
        {
            Kameleo.LocalApiClient.Client.RequestOptions localVarRequestOptions = new Kameleo.LocalApiClient.Client.RequestOptions();
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Kameleo.LocalApiClient.Client.ClientUtils.ParameterToMultiMap("", "lifetimeState", lifetimeState));
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;ProfilePreview&gt;</returns>
        public async System.Threading.Tasks.Task<List<ProfilePreview>> ListProfilesAsync(ProfileLifetimeState? lifetimeState = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            Kameleo.LocalApiClient.Client.ApiResponse<List<ProfilePreview>> localVarResponse = await ListProfilesWithHttpInfoAsync(lifetimeState, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ProfilePreview&gt;)</returns>
        public async System.Threading.Tasks.Task<Kameleo.LocalApiClient.Client.ApiResponse<List<ProfilePreview>>> ListProfilesWithHttpInfoAsync(ProfileLifetimeState? lifetimeState = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
