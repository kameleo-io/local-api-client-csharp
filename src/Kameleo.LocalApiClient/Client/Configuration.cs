...
namespace Kameleo.LocalApiClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public static readonly ExceptionFactory DefaultExceptionFactory = (methodName, response) =>
        {
            ...
            {
                return new HttpRequestException(response.StatusCode.ToString(),
                    new ApiException(
                        status,
                        string.Format("Error calling {0}: {1}", methodName, status == 0 ? response.ErrorText : response.RawContent),
                        status == 0 ? response.ErrorText : response.RawContent,
                        response.Headers));
            }
            return null;
        };
        ...
        {
            Proxy = null;
            UserAgent = "KameleoLocalApiClient/v4.3.0/csharp";
        ...
        public Configuration(
            ...
            string basePath = "http://localhost:5050") : this()
        {
        ...
        /// <summary>
        /// Gets or sets the HTTP timeout of ApiClient. Defaults to 90 seconds.
        /// </summary>
        ...
        {
            string report = "C# SDK (Kameleo.LocalApiClient) Debug Report:\n";
