...
namespace Kameleo.LocalApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BrowserCookie")]
    public partial class BrowserCookie : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="hostOnly">Host Only cookie means that the cookie should be handled by the browser to the server only to the same host/server that firstly sent it to  the browser. (required).</param>
        /// <param name="httpOnly">When this attribute is set, client-side scripts are not allowed to access the cookie. (required).</param>
        /// <param name="secure">A cookie with the Secure attribute is sent to the server only with an encrypted request over the HTTPS protocol, never with unsecured HTTP,  and therefore can&#39;t easily be accessed by a man-in-the-middle attacker. Insecure sites (with http: in the URL) can&#39;t set cookies with the  Secure attribute. (required).</param>
        /// <param name="sameSite">The sameSite attribute lets servers require that a cookie shouldn&#39;t be sent with cross-origin requests (where Site is defined by the  registrable domain), which provides some protection against cross-site request forgery attacks (CSRF).  It takes three possible values: Strict, Lax, and None.With Strict, the cookie is sent only to the same site as the one that originated it;  Lax is similar, with an exception for when the user navigates to a URL from an external site, such as by following a link; None has no  restrictions on cross-site requests. (required).</param>
        ...
        public BrowserCookie(string domain = default, string name = default, string path = default, string value = default, bool hostOnly = default, bool httpOnly = default, bool secure = default, string sameSite = default, long? expirationDate = default, bool session = default, string storeId = default)
        {
            ...
            if (domain == null)
            {
                throw new ArgumentNullException("domain is a required property for BrowserCookie and cannot be null");
            }
            this.Domain = domain;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for BrowserCookie and cannot be null");
            }
            this.Name = name;
            // to ensure "path" is required (not null)
            if (path == null)
            {
                throw new ArgumentNullException("path is a required property for BrowserCookie and cannot be null");
            }
            this.Path = path;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for BrowserCookie and cannot be null");
            }
            this.Value = value;
            this.HostOnly = hostOnly;
            this.HttpOnly = httpOnly;
            this.Secure = secure;
            // to ensure "sameSite" is required (not null)
            if (sameSite == null)
            {
                throw new ArgumentNullException("sameSite is a required property for BrowserCookie and cannot be null");
            }
        ...
        */
        [DataMember(Name = "hostOnly", IsRequired = true, EmitDefaultValue = true)]
        ...
        */
        [DataMember(Name = "httpOnly", IsRequired = true, EmitDefaultValue = true)]
        ...
        */
        [DataMember(Name = "sameSite", IsRequired = true, EmitDefaultValue = true)]
        public string SameSite { get; set; }

        /// <summary>
        /// This unix timestamp formatted attribute is used to set persistent cookies. It signifies how long the browser should use the persistent  cookie and when the cookie should be deleted.  If this attribute is not specified, then the lifetime of the cookie is the same as that of browser session, i.e.it will be a non-persistent  cookie.
        /// </summary>
        /// <value>This unix timestamp formatted attribute is used to set persistent cookies. It signifies how long the browser should use the persistent  cookie and when the cookie should be deleted.  If this attribute is not specified, then the lifetime of the cookie is the same as that of browser session, i.e.it will be a non-persistent  cookie.</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>Session cookies are deleted when the current session ends. The browser defines when the \&quot;current session\&quot; ends, and some browsers use  session restoring when restarting, which can cause session cookies to last indefinitely long.</value>
        /*
        <example>false</example>
        */
        ...
        /// </summary>
        /// <value>The ID of the cookie store containing this cookie.</value>
        /*
        <example>0</example>
        */
