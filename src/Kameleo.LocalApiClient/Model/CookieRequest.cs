...
namespace Kameleo.LocalApiClient.Model
{
    ...
    public partial class CookieRequest : IValidatableObject
    {
        ...
        public CookieRequest(string domain = default(string), string name = default(string), string path = default(string), string value = default(string), bool hostOnly = default(bool), bool httpOnly = default(bool), bool secure = default(bool), string sameSite = default(string), long? expirationDate = default(long?))
        {
