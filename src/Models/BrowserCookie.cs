...
namespace Kameleo.LocalApiClient.Models
{
    ...
    /// </summary>
    public partial class BrowserCookie
    {
        /// <summary>
        /// Initializes a new instance of the BrowserCookie class.
        /// </summary>
        ...
        /// <param name="expirationDate">This unix timestamp formatted
        /// attribute is used to set persistent cookies. It signifies how long
        /// the browser should use the persistent cookie and when the cookie
        /// should be deleted.
        ...
        /// <param name="session">Session cookies are deleted when the current
        /// session ends. The browser defines when the "current session" ends,
        /// and some browsers use session restoring when restarting, which can
        /// cause session cookies to last indefinitely long.</param>
        /// <param name="storeId">The ID of the cookie store containing this
        /// cookie.</param>
        public BrowserCookie(string domain, string name, string path, string value, bool hostOnly, bool httpOnly, bool secure, string sameSite, long? expirationDate = default(long?), bool? session = default(bool?), string storeId = default(string))
        {
            Domain = domain;
            Name = name;
            Path = path;
        ...
        public virtual void Validate()
        {
            ...
            if (SameSite == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "SameSite");
            }
        }
    }
}
