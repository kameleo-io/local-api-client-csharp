...
namespace Kameleo.LocalApiClient.Models
{
    ...
    public partial class CreateProfileRequest
    {
        ...
        /// <param name="name">Sets a human-readable name for the profile,
        /// which is modifiable at any time.</param>
        ...
        /// <summary>
        /// Gets or sets sets a human-readable name for the profile, which is
